...
def read_database(frequency):
    ...
    for document in cursor:  
        ...
        try:
            ...
            SP1_visibilities.append(document['summary']['SP0']['visibilities'])
            SP1_flux.append(document['summary']['SP0']['flux'])
            SP1_clean.append(document['summary']['SP0']['clean_components'])
            SP1_rms.append(document['summary']['SP0']['rms'])
